...
function filterDormInfo(con, request, callback) {
  ...
  a.P_BATHROOM as BATHROOM, a.P_KITCHEN as P_KITCHEN, c.FRESHMAN, c.SOPHOMORE, c.JUNIOR, c.SENIOR, ifnull(s.TWO_SUITE, 0) as TWO_SUITE, ifnull(s.THREE_SUITE, 0) as THREE_SUITE, 
