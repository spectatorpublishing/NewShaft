...
export const Fonts = () => (
  <ThemeSection>
    ...
    <h3>Heading3 {'<h3>'}</h3>
    <h4>
      Heading4 {'<h4>'} - (identical to {'<b>'})
    </h4>
    <h5>
      Heading5 {'<h5>'} - (identical to {'<p>'})
    </h5>
    <h6>Heading6 {'<h6>'} - use only as caption or fine print (hard to read)</h6>
    <br />
    <p>
      Text {'<p>'} - (identical to {'<h5>'}
    </p>
    <b>
      TextBold {'<b>'} - (identical to {'<h4>'})
    </b>
  </ThemeSection>
);
...
export const Colors = () => (
  <ThemeSection>
    ...
    <br />
    <h6>
      except `shadow` should only be used with the `text-shadow` or `box-shadow` css property:
    </h6>
    ...
    <ClearBG>
      <BarnardBlue>barnardBlue</BarnardBlue>
    </ClearBG>
    <ClearBG>
      <ColumbiaBlue>columbiaBlue</ColumbiaBlue>
    </ClearBG>
    <BlackBG>
      <White>white on black</White>
    </BlackBG>
    <BarnardBlueBG>
      <White>white on barnardBlue</White>
    </BarnardBlueBG>
    <ColumbiaBlueBG>
      <WhiteShadowed>white with shadow on columbiaBlue</WhiteShadowed>
    </ColumbiaBlueBG>
    <ClearBG>
      <WhiteShadowed>shadow</WhiteShadowed>
    </ClearBG>
    <ClearBG>
      <DarkGray>darkGray</DarkGray>
    </ClearBG>
    <BorderBG>
      <LightGray>lightGray with lightGray border</LightGray>
    </BorderBG>
    <br />
    <br />
